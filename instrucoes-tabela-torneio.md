...
Atualize o método Kotlin `fetchAndCacheTournamentCatalog` da classe `SuperbetStrategy` conforme abaixo.

## Problema atual
- O campo `tournamentName` está sendo preenchido com `Torneio não identificado`.
